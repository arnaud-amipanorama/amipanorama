            ...
            <AnimateOnView key={city} delay={i * 0.06}>
              <div className="hover-row" role="button" tabIndex={0}
                ...
                <div style={{ position: "relative", minHeight: 280, overflow: "hidden" }}>
                  ...
                  {phare && (
                    <div style={{ position: "absolute", top: 18, left: 28, fontSize: 10, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#fff", background: "rgba(27,61,136,0.92)", borderRadius: 100, padding: "4px 12px" }}>Destination phare</div>
                  )}
                </div>
